  ...
  return (
    <div class="mt-8">
      <a href={`/movies/${movie.id}`}>
        <img width="224" height="336" loading={loading} decoding="async" src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} alt={`${movie.title} Poster`} class="thumbnail hover:opacity-75 transition ease-in-out duration-150" id={`movie-poster-${movie.id}`} />
      </a>
      <div class="mt-2">
