export default function MovieDetails({ person, social, credits, knownFor }) {
  return (
    <>
      <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
              <img src={person.profile_path} alt={person.name} class="person-photo w-76" id="person-photo" />
              <ul class="flex items-center mt-4">
                ...
                {social.twitter_id && (
                  <li class="ml-6">
                    <a href={`https://www.twitter.com/${social.twitter_id}`} title="Twitter" target="_blank">
                ...
                {knownFor.map(movie => (
                  <div class="mt-4">
                    <a href={movie.linkToPage}>
                      <img src={movie.poster_path} alt={movie.title} class="thumbnail hover:opacity-75 transition ease-in-out duration-150" id={`movie-poster-${movie.id}`} />
                    </a>
